    ...
    <div className="container px-4 md:px-6">
      <div className="mx-auto grid max-w-5xl items-center gap-6 lg:grid-cols-3 lg:gap-12">
        <div className="grid gap-1">
          <InteractiveTutorialsIcon />
          <h3 className="text-xl font-bold">Interactive Tutorials</h3>
          <p className="text-muted-foreground">Learn by doing with our interactive coding tutorials.</p>
        </div>
        <div className="grid gap-1">
          <CodingChallengesIcon />
          <h3 className="text-xl font-bold">Coding Challenges</h3>
          <p className="text-muted-foreground">Test your skills with a variety of coding challenges.</p>
        </div>
        <div className="grid gap-1">
          <LearningResourcesIcon />
          <h3 className="text-xl font-bold">Learning Resources</h3>
          <p className="text-muted-foreground">Access a library of coding tutorials, articles, and videos.</p>
        </div>
      </div>
    </div>
  </section>
...
const InteractiveTutorialsIcon = () => (
